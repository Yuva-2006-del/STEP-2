...
public class UniversitySystem {
    public static void main(String[] args) {
        ...
        System.out.println("Student name via Person reference: " + p.name);

      
        System.out.println("\n[Explanation]");
        System.out.println("Upcasting is safe because a Student IS-A Person.");
        System.out.println("But subclass-specific methods like attendLecture() are hidden when upcast.");
    }
}
